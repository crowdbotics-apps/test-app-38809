"""test_app_38809 URL Configuration
...
urlpatterns = [
    ...
    path("rest-auth/registration/", include("rest_auth.registration.urls")),path("api/v1/", include("article.api.v1.urls")), path("article/", include("article.urls")), path("api/v1/", include("kpi_dashboar_dm.api.v1.urls"))
